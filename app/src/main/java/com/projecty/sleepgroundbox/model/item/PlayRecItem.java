 ...
 */
public class PlayRecItem extends PlayItem {

    public PlayRecItem(JSONObject jsonItem) throws JSONException, ParseException {

        JSONObject snippet = jsonItem.getJSONObject("snippet");
        id = jsonItem.getJSONObject("contentDetails").getString("videoId");
