...
public abstract class GetPlayListPageAsyncTask extends AsyncTask<String, Void, JSONObject> {
    private static final String TAG = "GetYouTubelistAsyncTask";

    private static final int YOUTUBE_PLAYLIST_MAX_RESULTS = 10;
    private static final String YOUTUBE_URL_BEGIN = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=";
    private static final String YOUTUBE_URL_END = "&key=AIzaSyDrp3hVd7PBIryKmk3nBcPIoxTOX5kTPvQ";
...
//    , statistics(viewCount, videoCount))";
    ...
    public GetPlayListPageAsyncTask(String id) {
        String url = YOUTUBE_URL_BEGIN + id + YOUTUBE_URL_END;
